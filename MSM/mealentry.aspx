<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mealentry.aspx.cs" Inherits="MSM.mealentry" %>
...
<head runat="server">
    ...
    <style>
     ...
     <script>
        $(Document).ready(function () {
            $("#gvmealentry").prepend($("<thead></thead>").append($(this).find("tr:first"))).dataTable();
        });
    </script>
</head>
<body>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="dailycost.aspx">Daily Cost</a></li>
          <li  class="active"><a href="mealentry.aspx">Meal Entry</a></li>
      </ul>
          ...
          <asp:Button ID="btnlogout" runat="server" Text="Log Out" OnClick="btnlogout_Click" />
            ...
            <div class="row">
                <div class="col-md-4">
                  ...
                  <div class="panel-heading">Membar Meal Entry</div>
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                        <label for="txtid">Meal Amount (Per Day):</label>
                ...
                <div class="col-md-8">
                    <asp:GridView ID="gvmealentry" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1">
                        <Columns>
                            <asp:BoundField DataField="m_date" HeaderText="Meal Entry Date" SortExpression="m_date" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="m_id" HeaderText="Membar ID" SortExpression="m_id" />
                            <asp:BoundField DataField="p_meal" HeaderText="Par Day Meal Amount" SortExpression="p_meal" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT * FROM [tbl_meal]"></asp:SqlDataSource>
                </div>
            </div>
        </div>
    </form>
