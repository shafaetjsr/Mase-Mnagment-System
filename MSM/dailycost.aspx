<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dailycost.aspx.cs" Inherits="MSM.dailycost" %>
...
<head runat="server">
    ...
    <script>
        $(Document).ready(function () {
            $("#gvdailycost").prepend($("<thead></thead>").append($(this).find("tr:first"))).dataTable();
        });
    </script>
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li><a href="Payment.aspx">Add Payment</a></li>
          <li  class="active"><a href="dailycost.aspx">Daily Cost</a></li>
          ...
          <asp:Button ID="btnlogout" runat="server" Text="Log Out" OnClick="btnlogout_Click" />
            ...
            <div class="row">
                ...
                <div class="panel panel-primary">
                  <div class="panel-heading">Daily Bazar Cost</div>
                  <div class="panel-body">
                      ...
                      <div class="form-group">
                        <label for="txtcom">Comment:</label>
                ...
                <div class="col-md-8">
                    <asp:GridView ID="gvdailycost" runat="server" AutoGenerateColumns="False" DataKeyNames="id" DataSourceID="SqlDataSource1">
                        <Columns>
                            <asp:BoundField DataField="c_date" HeaderText="Cost data" SortExpression="c_date" DataFormatString="{0:dd/MM/yyyy}" />
                            <asp:BoundField DataField="amount" HeaderText="Amount" SortExpression="amount" />
                            <asp:BoundField DataField="comment" HeaderText="Comment" SortExpression="comment" />
                        </Columns>
                    </asp:GridView>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbconn %>" SelectCommand="SELECT * FROM [daily_cost]"></asp:SqlDataSource>
                </div>
            </div>
